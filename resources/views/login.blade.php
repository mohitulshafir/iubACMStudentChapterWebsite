            ...
            <div class="row">
                <div class="col-sm-8 m-auto">
                    ...
                    <h1 style="color: rgb(96, 96, 168)"
                        class="h1-responsive font-weight-bold text-center my-5 title-left ">Admin Login</h1>
                </div>
            </div>
            <div style="align-items: center" class="col-lg-6">
                <div class="card mb-6">      
                    <div  class="table-responsive p-3">  
                        <form action="{{ route('admindashboard') }}" class="login__form" method="POST">
                            @csrf
                            ...
                            <div style="text-align: center">
                                <button id="submit" class="btn btn-primary" type="submit">Sign In</button><br>
                                <p> <br> <a href="">Create Account?</a></p>
                            </div>
                            <button class="btn btn-sm btn-success" type="submit"><a href="/" style="color: white">Go to Home</a></button>
                        </form>
